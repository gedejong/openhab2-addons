...
public enum CosemObjectType {
    ...
    EMETER_ACTUAL_DELIVERY(new OBISIdentifier(1, 0, 1, 7, 0, null), new CosemValueDescriptor(CosemFloat.class, "kW")),
    EMETER_ACTUAL_PRODUCTION(new OBISIdentifier(1, 0, 2, 7, 0, null), new CosemValueDescriptor(CosemFloat.class, "kW")),
    ...
    EMETER_TRESHOLD_KWH(new OBISIdentifier(0, 0, 17, 0, 0, null), new CosemValueDescriptor(CosemFloat.class, "kW")),
    ...
    EMETER_POWER_FAILURES(new OBISIdentifier(0, 0, 96, 7, 21, null), new CosemValueDescriptor(CosemFloat.class, "")),
    ...
    EMETER_VOLTAGE_SAGS_L1(new OBISIdentifier(1, 0, 32, 32, 0, null), new CosemValueDescriptor(CosemFloat.class, "")),
    EMETER_VOLTAGE_SAGS_L2(new OBISIdentifier(1, 0, 52, 32, 0, null), new CosemValueDescriptor(CosemFloat.class, "")),
    EMETER_VOLTAGE_SAGS_L3(new OBISIdentifier(1, 0, 72, 32, 0, null), new CosemValueDescriptor(CosemFloat.class, "")),
    EMETER_VOLTAGE_SWELLS_L1(new OBISIdentifier(1, 0, 32, 36, 0, null), new CosemValueDescriptor(CosemFloat.class, "")),
    EMETER_VOLTAGE_SWELLS_L2(new OBISIdentifier(1, 0, 52, 36, 0, null), new CosemValueDescriptor(CosemFloat.class, "")),
    EMETER_VOLTAGE_SWELLS_L3(new OBISIdentifier(1, 0, 72, 36, 0, null), new CosemValueDescriptor(CosemFloat.class, "")),
    ...
    EMETER_INSTANT_POWER_PRODUCTION_L3(new OBISIdentifier(1, 0, 62, 7, 0, null),
            new CosemValueDescriptor(CosemFloat.class, "kW")),
    EMETER_INSTANT_VOLTAGE_L1(new OBISIdentifier(1, 0, 32, 7, 0, null),
            new CosemValueDescriptor(CosemFloat.class, "V")),
    EMETER_INSTANT_VOLTAGE_L2(new OBISIdentifier(1, 0, 52, 7, 0, null),
            new CosemValueDescriptor(CosemFloat.class, "V")),
    EMETER_INSTANT_VOLTAGE_L3(new OBISIdentifier(1, 0, 72, 7, 0, null),
            new CosemValueDescriptor(CosemFloat.class, "V")),
